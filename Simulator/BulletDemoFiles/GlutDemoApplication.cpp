...
void GlutDemoApplication::updateCamera() {
...
void	GlutDemoApplication::setCameraDistance(float dist)
{
	m_cameraDistance  = dist;
}

float	GlutDemoApplication::getCameraDistance()
{
	return m_cameraDistance;
}

void GlutDemoApplication::moveAndDisplay()
{
	if (!m_idle)
...
void	GlutDemoApplication::clientResetScene()
{
...
void GlutDemoApplication::zoomOut()
{
	m_cameraDistance += btScalar(m_zoomStepSize); updateCamera();

}

void GlutDemoApplication::reshape(int w, int h)
{
...
void GlutDemoApplication::keyboardCallback(unsigned char key, int x, int y)
{
	(void)x;
	(void)y;
...
btVector3	GlutDemoApplication::getRayTo(int x,int y)
{
...
void GlutDemoApplication::mouseFunc(int button, int state, int x, int y)
{
	if (state == 0)
	{
...
void GlutDemoApplication::pickObject(const btVector3& pickPos, const btCollisionObject* hitObj)
{
...
void GlutDemoApplication::removePickingConstraint()
{
...
void	GlutDemoApplication::mouseMotionFunc(int x,int y)
{
...
void GlutDemoApplication::setOrthographicProjection()
{
...
void GlutDemoApplication::resetPerspectiveProjection()
{
...
void GlutDemoApplication::displayProfileString(int xOffset,int yStart,char* message)
{
...
void GlutDemoApplication::showProfileInfo(int& xOffset,int& yStart, int yIncr)
{
#ifndef BT_NO_PROFILE
...
//
void	GlutDemoApplication::renderscene(int pass)
{
	btScalar	m[16];
...
//
void GlutDemoApplication::renderme()
{
	myinit();
...
void GlutDemoApplication::myinit(void)
{
...
void GlutDemoApplication::overrideGLShapeDrawer (GL_ShapeDrawer* shapeDrawer)
{
